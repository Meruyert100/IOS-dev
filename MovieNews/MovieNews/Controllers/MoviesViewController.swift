...
class MoviesViewController: UIViewController {
    ...
    lazy var refreshControl: UIRefreshControl = {
        ...
        result.attributedTitle = NSAttributedString(string: "Refreshing...", attributes: [ NSAttributedString.Key.foregroundColor: UIColor.tintColor ]);
    ...
    let movieDataSource: DataSource = MovieDatabase();
    ...
    override func viewDidLayoutSubviews() {
        ...
        self.collectionView.contentInset = UIEdgeInsets(top: self.view.layoutMargins.left, left: 0, bottom: self.view.layoutMargins.left, right: 0);
    }
...
extension MoviesViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if let flowLayout = collectionView.collectionViewLayout as? UICollectionViewFlowLayout {
            let cellWidth = (collectionView.frame.width - flowLayout.minimumInteritemSpacing );
